package ufficio.it.begear.controller;
...
import ufficio.it.begear.view.MenuDipartimento;
import ufficio.it.begear.view.MenuImpiegato;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Utility.mioLogger().setLevel(Level.DEBUG);
