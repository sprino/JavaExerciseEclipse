...
CREATE TABLE `Animale` (
  `Cartellino` int(11) NOT NULL AUTO_INCREMENT,
  `Razza` varchar(25) DEFAULT NULL,
  `Nome` varchar(25) NOT NULL,
  PRIMARY KEY (`Cartellino`)
...
INSERT INTO `Animale` VALUES (1,'Cane','Bobby'),(2,'Gatto','Miao'),(3,'Gatto','Bianchina');
